...
// Trocado do next-themes para o tema do próprio projeto: duas bibliotecas
// decidindo o mesmo tema é como um bug entra.
import { useEstaEscuro } from "@/lib/tema"
...
export function MagicCard(props: MagicCardProps) {
  ...
  const escuro = useEstaEscuro()
  const [mounted, setMounted] = useState(false)

  useEffect(() => setMounted(true), [])

  const isDarkTheme = mounted ? escuro : true
